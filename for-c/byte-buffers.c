...
int main() {
   ...
   // т.е. в горните сметки ще трябва да променим реда на нарастване на значителността (basically го интерпретираме човешки като числото 7a79 7877)
   //  7*16^7 + a*16^6 + 7*16^5 + 9*16^4 + 7*16^3 + 8*16^2 + 7*16^1 + 7*16^0   = 2054781047
   ...
   // вместо 7*16^3 + 7*16^2 + 7*16^1 + 8*16^0 ще смятаме 7*16^3 + 8*16^2 + 7*16^1 + 7*16^0 (все едно гледаме 7877) = 30839
   // вместо 7*16^3 + 9*16^2 + 7*16^1 + a*16^0 ще смятаме 7*16^3 + a*16^2 + 7*16^1 + 9*16^0 (все едно гледаме 7a79) = 31353
